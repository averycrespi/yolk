...
fn source_to_envs(source: &str) -> Result<Vec<Environment>, Error> {
...
#[test]
fn test_let_number() -> Result<(), Error> {
...
#[test]
fn test_let_array() -> Result<(), Error> {
...
#[test]
fn test_let_infix() -> Result<(), Error> {
