    ...
    match node {
        ...
        YololNode::PrefixExpr { op, expr } => match (op, *expr.clone()) {
            ...
            (op, YololNode::Literal(y)) => match op {
                ...
                PrefixOp::Sqrt if y >= YololNumber::zero() => YololNode::Literal(y.sqrt()),
                PrefixOp::Sin => YololNode::Literal(y.sin()),
                PrefixOp::Cos => YololNode::Literal(y.cos()),
                PrefixOp::Tan if y.cos() != YololNumber::zero() => YololNode::Literal(y.tan()),
                PrefixOp::Asin if y.abs() <= YololNumber::one() => YololNode::Literal(y.arcsin()),
                PrefixOp::Acos if y.abs() <= YololNumber::one() => YololNode::Literal(y.arccos()),
